...
public class Database {
    ...
    private static final String SQL_INSERT_ONE_IDEAS_TBL = "INSERT INTO ideas_tbl" +
            " VALUES (default, ?, ?);";
    ...
    private static final String SQL_SELECT_ALL_IDEAS_TBL = "SELECT id, likes, message" +
            " FROM ideas_tbl;";
