 ...
 * @param mMessage only useful when mStatus indicates an error, or when data is null
 * @param mData any JSON-friendly object can be referenced here, so a client gets a rich reply
 */
