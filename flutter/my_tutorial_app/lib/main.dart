              ...
              itemBuilder: /*1*/ (context, i) {
                return Column(
                  children: <Widget>[
                    ListTile(
                      title: Text(
                        "Idea ${i}: num=${snapshot.data![i].mLikes} str=${snapshot.data![i].mId}",
                        // snapshot.data![i].str,
                        style: _biggerFont,
                      ),
                    ),
...
Future<List<NumberWordPair>> doSomeLongRunningCalculation() async {
...
//       .get(Uri.parse('https://team-untitled-23.dokku.cse.lehigh.edu/ideas'));
